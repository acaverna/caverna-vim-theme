" Normal mode
let s:N1 = [ '#EEEEEE' , '#18203E' , 255 , 89  ] " guifg guibg ctermfg ctermbg
let s:N2 = [ '#EEEEEE' , '#071D6E' , 255 , 18  ] " guifg guibg ctermfg ctermbg
let s:N3 = [ '#B3B1AD' , '#0B2BA2' , 250 , 27  ] " guifg guibg ctermfg ctermbg

" Insert mode
let s:I1 = [ '#EEEEEE' , '#006CA1' , 255 , 39   ] " guifg guibg ctermfg ctermbg
let s:I2 = [ '#6FD3FA' , '#071D6E' , 39 , 18  ] " guifg guibg ctermfg ctermbg
let s:I3 = [ '#6FD3FA' , '#0B2BA2' , 39 , 27  ] " guifg guibg ctermfg ctermbg

" Visual mode
let s:V1 = [ '#0B2BA2' , '#F0EE00' , 255 , 11  ] " guifg guibg ctermfg ctermbg
let s:V2 = [ '#F0EE00' , '#071D6E' , 11 , 18  ] " guifg guibg ctermfg ctermbg
let s:V3 = [ '#F0EE00' , '#0B2BA2' , 11 , 27  ] " guifg guibg ctermfg ctermbg

" Replace mode
let s:RE = [ '#EEEEEE' , '#E85F3F' , 255  , 1 ] " guifg guibg ctermfg ctermbg

"modified color
let s:modified  = [22, '#30DB22']
